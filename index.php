...
<head>
	<title>Blood Bank Management System| Home Page</title>
...
{ ?>
				<div class="col-md-4 pricing" style="margin-top:2%;">
					...
					<div class="price-top">
							...
							<img src="images/pic/donner.png" alt="" class="img-fluid" />
...
<li>AB positive or AB negative.</li>
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="images/pic/hero.jpg" alt="">
            </div>
        </div>
